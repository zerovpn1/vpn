...
echo "Telegram t.me/zeroooo99"
echo "WhatsApp wa.me/6287705721860"
rm -f setup.sh
exit 0
fi
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : ZERO VPN"  | tee -a log-install.txt
echo "   - Telegram                : T.me/zeroooo99"  | tee -a log-install.txt
echo "   - Instagram               : @z3zeiy"  | tee -a log-install.txt
